...
Public Class BDD
    '' version finale (20/04/20202 23:45 ) < -- commentaire a supprimer 
...
=======
    ...
    Public Shared stringMATIERE() As String = {BDD.champsCodeMat, BDD.champsCOMAMA, BDD.champsCodePromo, BDD.champsANSCMA, BDD.champsOPTIMA, BDD.champsCYCLMA, BDD.champsLIBEMA, BDD.champsTYPEMA}
    Public Shared stringNOTERATRAP() As String = {BDD.champsCodeRat, BDD.champsMATRIN}
    Public Shared stringRATRAP() As String = {"CYCLRA", "ANSCRA", "OPTIRA"}
>>>>>>> Stashed changes
...
=======
    ...
    Public Shared numMATIERE() As String = {BDD.champsANETMA, BDD.champsCOEFMA, BDD.champsMOYMAT}

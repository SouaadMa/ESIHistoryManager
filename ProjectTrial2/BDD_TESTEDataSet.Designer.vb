...
Partial Public Class BDD_TESTEDataSet
    ...
    Private relationETUDIANTNOTES As Global.System.Data.DataRelation
    ...
    Private Sub InitClass()
        ...
        Me.relationETUDIANTNOTES = New Global.System.Data.DataRelation("ETUDIANTNOTES", New Global.System.Data.DataColumn() {Me.tableETUDIANT.MATRINColumn}, New Global.System.Data.DataColumn() {Me.tableNOTES.MATRINColumn}, false)
        Me.Relations.Add(Me.relationETUDIANTNOTES)
    ...
    Partial Public Class NoteRATRAPDataTable
        ...
        <Global.System.Diagnostics.DebuggerNonUserCodeAttribute(),  _
         Global.System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "4.0.0.0")>  _
        Public Overloads Function AddNoteRATRAPRow(ByVal parentRATRAPRowByRATRAPNoteRATRAP As RATRAPRow, ByVal parentETUDIANTRowByETUDIANTNoteRATRAP As ETUDIANTRow, ByVal MOYERA As Double, ByVal MENTRA As Integer, ByVal ELIMRA As Integer) As NoteRATRAPRow
            Dim rowNoteRATRAPRow As NoteRATRAPRow = CType(Me.NewRow,NoteRATRAPRow)
            Dim columnValuesArray() As Object = New Object() {Nothing, Nothing, MOYERA, MENTRA, ELIMRA}
    ...
    Partial Public Class NOTESDataTable
        ...
        Public Overloads Function AddNOTESRow(ByVal parentMATIERERowByMATIERENOTES As MATIERERow, ByVal parentETUDIANTRowByETUDIANTNOTES As ETUDIANTRow, ByVal CodePromo As String, ByVal NOJUNO As Double, ByVal NOSYNO As Double, ByVal NORANO As Double, ByVal ELIMNO As String, ByVal RATRNO As Integer) As NOTESRow
            ...
            End If
            If (Not (parentETUDIANTRowByETUDIANTNOTES) Is Nothing) Then
                columnValuesArray(1) = parentETUDIANTRowByETUDIANTNOTES(5)
            End If
    ...
    Partial Public Class ETUDIANTRow
        ...
        Public Function GetNOTESRows() As NOTESRow()
            If (Me.Table.ChildRelations("ETUDIANTNOTES") Is Nothing) Then
                Return New NOTESRow(-1) {}
            Else
                Return CType(MyBase.GetChildRows(Me.Table.ChildRelations("ETUDIANTNOTES")),NOTESRow())
            End If
        End Function
    End Class
    ...
    Partial Public Class NOTESRow
        ...
        Public Property NOJUNO() As Double
            Get
                Try 
                    Return CType(Me(Me.tableNOTES.NOJUNOColumn),Double)
                Catch e As Global.System.InvalidCastException
        ...
        Public Property NOSYNO() As Double
            Get
                Try 
                    Return CType(Me(Me.tableNOTES.NOSYNOColumn),Double)
                Catch e As Global.System.InvalidCastException
        ...
        Public Property NORANO() As Double
            Get
                Try 
                    Return CType(Me(Me.tableNOTES.NORANOColumn),Double)
                Catch e As Global.System.InvalidCastException
        ...
        Public Property ETUDIANTRow() As ETUDIANTRow
            Get
                Return CType(Me.GetParentRow(Me.Table.ParentRelations("ETUDIANTNOTES")),ETUDIANTRow)
            End Get
            Set
                Me.SetParentRow(value, Me.Table.ParentRelations("ETUDIANTNOTES"))
            End Set
        End Property
    ...
    Partial Public Class MATIERETableAdapter
        ...
        Public Overloads Overridable Function Update( _
            ...
            Else
                ...
                Me.Adapter.UpdateCommand.Parameters(14).Value = CType(Original_CYCLMA,String)
            End If
            If (Original_LIBEMA Is Nothing) Then
            ...
            Else
                ...
                Me.Adapter.UpdateCommand.Parameters(16).Value = CType(Original_LIBEMA,String)
            End If
            If (Original_TYPEMA Is Nothing) Then
            ...
            Else
                ...
                Me.Adapter.UpdateCommand.Parameters(18).Value = CType(Original_TYPEMA,String)
            End If
            If (Original_COEFMA.HasValue = true) Then
                Me.Adapter.UpdateCommand.Parameters(19).Value = CType(0,Object)
                Me.Adapter.UpdateCommand.Parameters(20).Value = CType(Original_COEFMA.Value,Integer)
            Else
            ...
            If (Original_MOYMAT.HasValue = true) Then
                ...
                Me.Adapter.UpdateCommand.Parameters(22).Value = CType(Original_MOYMAT.Value,Double)
            Else
    ...
    Partial Public Class NoteRATRAPTableAdapter
        ...
        Private Sub InitAdapter()
            ...
            Me._adapter.DeleteCommand.CommandText = "DELETE FROM `NoteRATRAP` WHERE ((`CodeRat` = ?) AND (`MATRIN` = ?) AND ((? = 1 AN"& _ 
                ...
                "NTRA` = ?)) AND ((? = 1 AND `ELIMRA` IS NULL) OR (`ELIMRA` = ?)))"
            Me._adapter.DeleteCommand.CommandType = Global.System.Data.CommandType.Text
            ...
            Me._adapter.InsertCommand = New Global.System.Data.OleDb.OleDbCommand()
            Me._adapter.InsertCommand.Connection = Me.Connection
            Me._adapter.InsertCommand.CommandText = "INSERT INTO `NoteRATRAP` (`CodeRat`, `MATRIN`, `MOYERA`, `MENTRA`, `ELIMRA`) VALU"& _ 
                "ES (?, ?, ?, ?, ?)"
            Me._adapter.InsertCommand.CommandType = Global.System.Data.CommandType.Text
            ...
            Me._adapter.UpdateCommand.CommandText = "UPDATE `NoteRATRAP` SET `CodeRat` = ?, `MATRIN` = ?, `MOYERA` = ?, `MENTRA` = ?, "& _ 
                "`ELIMRA` = ? WHERE ((`CodeRat` = ?) AND (`MATRIN` = ?) AND ((? = 1 AND `MOYERA` "& _ 
                "IS NULL) OR (`MOYERA` = ?)) AND ((? = 1 AND `MENTRA` IS NULL) OR (`MENTRA` = ?))"& _ 
                " AND ((? = 1 AND `ELIMRA` IS NULL) OR (`ELIMRA` = ?)))"
            Me._adapter.UpdateCommand.CommandType = Global.System.Data.CommandType.Text
        ...
        Private Sub InitCommandCollection()
            ...
            Me._commandCollection(0) = New Global.System.Data.OleDb.OleDbCommand()
            Me._commandCollection(0).Connection = Me.Connection
            Me._commandCollection(0).CommandText = "SELECT CodeRat, MATRIN, MOYERA, MENTRA, ELIMRA FROM NoteRATRAP"
            Me._commandCollection(0).CommandType = Global.System.Data.CommandType.Text
        End Sub
        ...
        <Global.System.Diagnostics.DebuggerNonUserCodeAttribute(),  _
         ...
         Global.System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter"),  _
         Global.System.ComponentModel.DataObjectMethodAttribute(Global.System.ComponentModel.DataObjectMethodType.Delete, true)>  _
        Public Overloads Overridable Function Delete(ByVal Original_CodeRat As String, ByVal Original_MATRIN As String, ByVal Original_MOYERA As Global.System.Nullable(Of Double), ByVal Original_MENTRA As Global.System.Nullable(Of Integer), ByVal Original_ELIMRA As Global.System.Nullable(Of Integer)) As Integer
        ...
        <Global.System.Diagnostics.DebuggerNonUserCodeAttribute(),  _
         ...
         Global.System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter"),  _
         Global.System.ComponentModel.DataObjectMethodAttribute(Global.System.ComponentModel.DataObjectMethodType.Insert, true)>  _
        Public Overloads Overridable Function Insert(ByVal CodeRat As String, ByVal MATRIN As String, ByVal MOYERA As Global.System.Nullable(Of Double), ByVal MENTRA As Global.System.Nullable(Of Integer), ByVal ELIMRA As Global.System.Nullable(Of Integer)) As Integer
        ...
        <Global.System.Diagnostics.DebuggerNonUserCodeAttribute(),  _
         ...
         Global.System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter"),  _
         Global.System.ComponentModel.DataObjectMethodAttribute(Global.System.ComponentModel.DataObjectMethodType.Update, true)>  _
        Public Overloads Overridable Function Update(ByVal CodeRat As String, ByVal MATRIN As String, ByVal MOYERA As Global.System.Nullable(Of Double), ByVal MENTRA As Global.System.Nullable(Of Integer), ByVal ELIMRA As Global.System.Nullable(Of Integer), ByVal Original_CodeRat As String, ByVal Original_MATRIN As String, ByVal Original_MOYERA As Global.System.Nullable(Of Double), ByVal Original_MENTRA As Global.System.Nullable(Of Integer), ByVal Original_ELIMRA As Global.System.Nullable(Of Integer)) As Integer
            If (CodeRat Is Nothing) Then
                Throw New Global.System.ArgumentNullException("CodeRat")
            Else
            ...
            If (Original_MATRIN Is Nothing) Then
                Throw New Global.System.ArgumentNullException("Original_MATRIN")
            Else
                Me.Adapter.UpdateCommand.Parameters(6).Value = CType(Original_MATRIN,String)
            End If
            If (Original_MOYERA.HasValue = true) Then
                Me.Adapter.UpdateCommand.Parameters(7).Value = CType(0,Object)
                Me.Adapter.UpdateCommand.Parameters(8).Value = CType(Original_MOYERA.Value,Double)
            Else
            ...
            If (Original_MENTRA.HasValue = true) Then
                ...
                Me.Adapter.UpdateCommand.Parameters(10).Value = CType(Original_MENTRA.Value,Integer)
            Else
            ...
            If (Original_ELIMRA.HasValue = true) Then
                ...
                Me.Adapter.UpdateCommand.Parameters(12).Value = CType(Original_ELIMRA.Value,Integer)
            Else
        ...
        <Global.System.Diagnostics.DebuggerNonUserCodeAttribute(),  _
         ...
         Global.System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter"),  _
         Global.System.ComponentModel.DataObjectMethodAttribute(Global.System.ComponentModel.DataObjectMethodType.Update, true)>  _
        Public Overloads Overridable Function Update(ByVal MOYERA As Global.System.Nullable(Of Double), ByVal MENTRA As Global.System.Nullable(Of Integer), ByVal ELIMRA As Global.System.Nullable(Of Integer), ByVal Original_CodeRat As String, ByVal Original_MATRIN As String, ByVal Original_MOYERA As Global.System.Nullable(Of Double), ByVal Original_MENTRA As Global.System.Nullable(Of Integer), ByVal Original_ELIMRA As Global.System.Nullable(Of Integer)) As Integer
            Return Me.Update(Original_CodeRat, Original_MATRIN, MOYERA, MENTRA, ELIMRA, Original_CodeRat, Original_MATRIN, Original_MOYERA, Original_MENTRA, Original_ELIMRA)
        End Function
    End Class

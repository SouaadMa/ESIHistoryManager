...
Public Class RNCrystalReport
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "EsistHistoryManagement_v1.RNCrystalReport.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedRNCrystalReport
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As RNCrystalReport = New RNCrystalReport()
        rpt.Site = Me.Site
        Return rpt
    End Function

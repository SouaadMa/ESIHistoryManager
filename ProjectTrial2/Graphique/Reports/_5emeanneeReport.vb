...
Public Class _5emeanneeReport
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "EsistHistoryManagement_v1._5emeanneeReport.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class Cached_5emeanneeReport
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As _5emeanneeReport = New _5emeanneeReport()
        rpt.Site = Me.Site
        Return rpt
    End Function

...
Public Class rng2lReport
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "EsistHistoryManagement_v1.rng2lReport.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class Cachedrng2lReport
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As rng2lReport = New rng2lReport()
        rpt.Site = Me.Site
        Return rpt
    End Function

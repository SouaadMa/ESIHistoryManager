Public Class SortieRN
    ...
    Public Sub New(ByVal etud As Etudiant, ByVal promo As String)
        ...
        If (Not promo.Substring(0, 1).Equals("5")) Then
            ...
            '************Récuperation de la moyenne de Rattrapage*******************'
            listeChamps.Clear()
        ...
        Else
            ...
            bilan = "La 5ème année ne contient pas de matières, veuillez consulter le Relevé de notes global, ou l'attestation de cet étudiant pour avoir plus de détails sur son évaluation de cette année. "
    ...
    Public Shared Sub ArrangeRATTRA(ByVal dt As DataTable, ByVal car_remplacement As Double)
